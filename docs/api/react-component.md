...
Avoid introducing any side-effects or subscriptions in this method. For those
...
Subsequent calls will override values from previous calls in the same cycle, so
